...
class SymbolTable:
    def __init__(self, keyword_list=[]):
        ...
        self.locs = [] # each symbol has a location (functions: first line no., vars: location in memory)
        self.lens = [] # each symbol may have a length (functions: X, normal vars: 1, arrs: N)
